...
class GL {
	...
	public static inline  function uniform1fv(location:GLUniformLocation, x:IMemoryRange):Void 
	{
	...
	public static inline  function uniform2fv(location:GLUniformLocation, v:IMemoryRange):Void 
	{
	...
	public static inline  function uniform3fv(location:GLUniformLocation, v:IMemoryRange):Void 
	{
	...
	public static inline  function uniform4fv(location:GLUniformLocation, v:IMemoryRange):Void 
	{
